              ...
              >
                ...
                <div className="flex-1">
                  ...
                  {isEditMode && editedContactInfo ? (
                    ...
                    <a 
                      href={`https://mail.google.com/mail/?view=cm&fs=1&to=${displayInfo?.email}`}
                      target="_blank"
            ...
            <div className="glass-effect rounded-2xl p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-sky-600 hover:bg-sky-700 transition-colors text-white py-3 px-6 rounded-lg font-semibold flex items-center justify-center gap-2 hover:shadow-lg hover:shadow-sky-500/30 transition-shadow disabled:opacity-50"
                >
                  {isSubmitting ? (
                    <>
